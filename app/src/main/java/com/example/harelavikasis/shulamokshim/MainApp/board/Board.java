package com.example.harelavikasis.shulamokshim.MainApp.board;

import android.util.Log;

import com.example.harelavikasis.shulamokshim.MainApp.exceptions.InitializationException;
import com.example.harelavikasis.shulamokshim.MainApp.exceptions.InvalidArgumentException;
...
public class Board {
    ...
    private void calculateNumberedSquaresForSingleMine(int x, int y) throws InitializationException {
        if (mCurrentState == MINES_PLACED) {
    ...
    public void addRandomMine() {
        ...
        try {
            ...
            do {
                // Randomly assign mines
                x = new Random().nextInt(mDimension);
                y = new Random().nextInt(mDimension);
            ...
            mCurrentState = MINES_PLACED;
            mNumMines ++;
            calculateNumberedSquaresForSingleMine(x,y);
//            MainApplication.getGameBus().post(new TileAddedEvent(x,y));
