...
import com.example.harelavikasis.shulamokshim.MainApp.game.Game;
import com.example.harelavikasis.shulamokshim.MainApp.utils.GraphicsUtils;
...
public class BoardLayoutView extends ViewGroup {
    ...
    public void setupBoard() throws InitializationException, InvalidArgumentException {
